...
"""
This scripts implements the Linear 1D interpolation in PyTorch as done in scipy.interpolate.interp1d
The code is adapted from https://github.com/aliutkus/torchinterp1d
"""
